        ...
        <div className="content-wrapper max-w-[1000px] mx-auto px-4 sm:px-6 md:px-8 lg:px-15 xl:px-16 relative z-[2]">
          ...
          <div className="mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <h1 className="relative">
              ...
              <span className="block text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[110px] font-extralight leading-[0.9] tracking-[-4px] font-sans bg-gradient-to-r from-white via-[#0084ff] via-[#0066cc] to-white bg-clip-text text-transparent animate-gradient-x relative">
                Datasets
                {/* Text shadow effect */}
                <span className="absolute inset-0 text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[110px] font-extralight leading-[0.9] tracking-[-4px] font-sans text-[#0084ff]/20 blur-sm animate-pulse">
                  Datasets
                </span>
              </span>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 lg:px-15 xl:px-16">
          ...
          <div className="text-center">
            <div className="max-w-4xl mx-auto">
              ...
              {/* Main Title */}
              <h2 className="text-5xl font-light mb-6 tracking-[-1px] font-sans text-white">
                Datasets & Software
              </h2>
