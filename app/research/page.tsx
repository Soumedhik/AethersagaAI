          ...
          <div className="content-wrapper max-w-[1200px] mx-auto px-[60px] relative z-[2]">
            ...
            <div className="mb-12 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              <p className="text-[clamp(1.125rem,2.5vw,1.5rem)] leading-relaxed text-[#b8b8b8] max-w-[800px] mx-auto font-light">
                ...
                theoretical foundations to practical applications. We push the boundaries
                of AI through groundbreaking research and interdisciplinary collaboration.
              </p>
            </div>
        ...
        <div className="max-w-[1400px] mx-auto px-[60px]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {[
              ...
              <div
                key={index}
                className="group relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-8 hover:bg-gradient-to-br hover:from-white/10 hover:to-white/15 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-[#0084ff]/10 overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-[#0084ff]/5 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="relative z-10">
                  <div className="flex items-center gap-4 mb-6">
                    {area.icon && (
                      <div className={`w-14 h-14 bg-gradient-to-br ${area.gradient} rounded-xl flex items-center justify-center text-2xl shadow-lg`}>
                        {area.icon}
                      </div>
                    )}
                    <div className="flex-1">
                      <h3 className="text-2xl font-semibold text-white mb-1 group-hover:text-[#0084ff] transition-colors duration-300">
                        {area.title}
                      </h3>
                      <div className={`h-1 bg-gradient-to-r ${area.gradient} rounded-full opacity-60 group-hover:opacity-100 transition-opacity duration-300`} />
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <h4 className="text-white font-semibold text-sm mb-3">Key Projects:</h4>
                    {area.projects.map((project, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-3 text-sm text-[#b8b8b8] group-hover:text-white/90 transition-colors duration-200"
                      >
                        <div className={`w-2 h-2 bg-gradient-to-r ${area.gradient} rounded-full opacity-60`} />
                        <span>{project}</span>
                      </div>
                    ))}
                  </div>
          ...
          <div className="mb-20">
            <div className="text-center mb-16">
              <h2 className="text-5xl md:text-6xl font-semibold text-white mb-6">
                Current <span className="bg-gradient-to-r from-[#0084ff] to-[#0066cc] bg-clip-text text-transparent">Projects</span>
              </h2>
              <p className="text-xl text-[#b8b8b8] max-w-3xl mx-auto">
                Explore our active research initiatives pushing the boundaries of AI and machine learning
              </p>
            </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between mb-6">
                      <div className={`px-4 py-2 bg-gradient-to-r from-[#0084ff] to-[#0066cc] rounded-full text-sm font-semibold text-white shadow-lg`}>
                        {project.status}
                      </div>
                      <ExternalLink className="w-5 h-5 text-[#b8b8b8] group-hover:text-[#0084ff] transition-colors duration-300" />
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-sm text-[#b8b8b8] group-hover:bg-white/10 group-hover:border-white/20 transition-all duration-300">
                        {project.status === "Active" ? "Ongoing Research" : "Completed"}
                      </span>
                    </div>
                  </div>
                </div>
